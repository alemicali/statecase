/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/cloud/wrangler.jsonc apps/cloud/worker-configuration.d.ts` (hash: de5b12c8840cf6311a33af81316ff839)
// Runtime types generated with workerd@1.20260903.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	BLOBS: R2Bucket;
	DB: D1Database;
	STATECASE_ENV: "production";
	STATECASE_ALLOWED_EMAILS: "hi@lumea.dev";
	STATECASE_GC_GRACE_DAYS: "30";
	BETTER_AUTH_URL: "https://statecase-api.hi-0e6.workers.dev";
	VAULTS: DurableObjectNamespace<import("./src/index").VaultCoordinator>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STATECASE_ENV" | "STATECASE_ALLOWED_EMAILS" | "STATECASE_GC_GRACE_DAYS" | "BETTER_AUTH_URL">> {}
}
